  ...
  <div className='relative min-h-screen'>
    ...
    <div className="flex justify-center items-center min-h-screen px-4 sm:px-0">
      <form 
        ...
        className="flex flex-col items-start bg-black/85 text-white rounded p-6 sm:p-8 w-full max-w-md"
      >
        {
          signUp ? (
            <>
              <p className='font-bold text-2xl sm:text-3xl mb-6 w-full'>Sign Up</p>
              <input
                ref={name}
                type='text'
            ...
            <p className='font-bold text-2xl sm:text-3xl mb-6 w-full'>Sign In</p>
          )
        }
        ...
        <button 
          ...
          className='w-full px-6 py-3 cursor-pointer bg-red-600 hover:bg-red-700 rounded font-bold'
        >
          {signUp ? "SignUp" : "SignIn"}
        </button>

        <p 
          className='pt-6 text-gray-300 text-sm sm:text-base'
